    ...
    return (
        <div className="sidebar-item">
            <div className={`sidebar-item__inner ${active}`} onClick={handleOpen}>
                ...
                {
                    props.listItem ? <span className="icon-right" onClick={handleOpen}><ChevronRight/></span> : null
                }
            </div>
            {
                open && props.listItem ? (
                    <ul className="sidebar-item__list">
                        {
                            props.name === 'Products' ? props.listItem.map((item, index) => {
                                return (
...
export default function Sidebar(props) {
    ...
    return (
        <div className={`${isOpen ? 'sidebar active' : 'sidebar'} `}  onClick={toggle} isOpen={isOpen}>
